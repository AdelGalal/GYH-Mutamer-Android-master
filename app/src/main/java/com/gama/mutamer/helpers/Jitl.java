...
import com.gama.mutamer.libs.AstroLib;
import com.gama.mutamer.libs.astro.Dms;
import com.gama.mutamer.viewModels.prayTimes.Astro;
import com.gama.mutamer.viewModels.prayTimes.DayCouple;
import com.gama.mutamer.viewModels.prayTimes.ExtremeLatitude;
import com.gama.mutamer.viewModels.prayTimes.LocationVM;
import com.gama.mutamer.viewModels.prayTimes.Mathhab;
import com.gama.mutamer.viewModels.prayTimes.Method;
import com.gama.mutamer.viewModels.prayTimes.Prayer;
import com.gama.mutamer.viewModels.prayTimes.PrayerTime;
import com.gama.mutamer.viewModels.prayTimes.Rounding;
import com.gama.mutamer.viewModels.prayTimes.SimpleDate;
 ...
 * to calculate prayer times for a specific LocationVM, using a specified method.
 */
public class Jitl {
     ...
     */
    public Jitl(LocationVM loc, Method method) {
        this.loc = loc;
        this.method = method;
    }
    ...
    static double getShoMag(LocationVM loc, Astro astro, PrayerTime type) {
     ...
     *
     * @param loc LocationVM where to calculate
     * @return a Dms object containg qibla direction
     */
    static public Dms getNorthQibla(LocationVM loc) {
    ...
    /**
     * changes the LocationVM
     *
     * @param loc the new LocationVM
     */
    public void setLocation(LocationVM loc) {
        this.loc = loc;
    }
    ...
    void getPrayerTimesByDay(Method method, DayCouple dc, DayPrayers pt,
         ...
         * LocationVM. The results are NOT the actual prayer times */
    ...
    public Prayer getImsaak(SimpleDate date) {
        ...
        if (method.getFajrInv() != 0) {
            if (method.getImsaakInv() == 0)
                ...
                tmpConf.setFajrInv(tmpConf.getFajrInv() + method
                        .getImsaakInv());
     ...
     * generate qibla direction
     *
     * @return a Dms object containing qibla direction for the current LocationVM
     */
