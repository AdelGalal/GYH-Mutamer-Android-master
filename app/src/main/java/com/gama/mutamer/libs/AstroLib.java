...
import com.gama.mutamer.viewModels.prayTimes.AstroDay;
...
public class AstroLib {
    ...
    public static double getRefraction(final LocationVM loc, double sunAlt) {
        double part1, part2;
    ...
    public static void getAstroValuesByDay(double julianDay,
                                           final LocationVM loc, Astro astro, Astro topAstro) {
    ...
    public static void computeTopAstro(final LocationVM loc, final Astro astro,
                                       Astro topAstro) {
        int i;
        double lHour, SP;
